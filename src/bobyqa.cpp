...
)
{
    ...
    /* Local variables */
    double f;
    long i__, j, k, ih, jp, ip, iq, np, iw;
...
)
{
    ...
    /* Local variables */
    double f = 0;
    long i__, j, k, ih, nf, jj, nh, ip, jp;
    double dx;
    long np;
...
double bobyqa_impl(const Function &function, long n, long npt, double *x,
    ...
    /* Local variables */
    long j, id_, np, iw, igo, ihq, ixb, ixa, ifv, isl, jsl, ipq, ivl, ixn, ixo, ixp, isu, jsu, ndim;
    double temp;
    long ibmat, izmat;
